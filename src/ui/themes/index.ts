...
export const GlobalThemeStore = observable.box(getTheme(localStorage.getItem('swoppySpace-theme')));
export const ThemeContext = React.createContext(getTheme(localStorage.getItem('swoppySpace-theme')));
